...
orcids <- data.frame(
  names = c("Matzinger, Andreas", "Sonnenberg, Hauke", "Rustler, Michael"),
  id = c("0000-0001-5483-4594", "0000-0001-9134-2871", "0000-0003-0647-7726"),
  stringsAsFactors =  FALSE)

authors <- kwb.orcid::get_author_meta_for_orcids(orcids$id)
```
...
```{r}
publications <- kwb.orcid::create_publications_df_for_orcids(orcids$id)
head(publications)
```
